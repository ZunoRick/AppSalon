...
async function mostrarServicios(){
    try{
        //const  url = 'http://localhost/servicios.php';
        const resultado = await fetch('./servicios.php');
...
function nombreCita() {
    ...
    nombreInput.addEventListener('input', e => {
        ...
        //Vlidación de que nombreTexto debe tener algo
...
function fechaCita() {
    ...
    fechaInput.addEventListener ('input', e =>{
        ...
        if ([0, 6].includes(dia)) {
            e.preventDefault();
            fechaInput.value = '';
            mostrarAlerta('No abrimos los fines de semana.', 'error');
        } else{
...
function deshabilitarFechaAnterior() {
    ...
    let mes  = (fechaAhora.getMonth() + 1).toString(), 
        dia  = (fechaAhora.getDate() + 1).toString();
